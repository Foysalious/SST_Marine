                  ...
                  <tr>
                    ...
                    <td>
                        @if ( $image->image == NULL )
                            No Image Attached
                        @else
                            <img src="{{ asset('images/aboutImages/' . $image->image ) }}" width="100">
                        @endif
                    </td>
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="{{ route('editAboutImage', $image->id) }}" class="btn btn-success btn-sm">Update</a>
                                    ...
                                    <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          ...
                                          <form action="{{ route('deleteAboutImage', $image->id ) }}" method="POST">
                                              @csrf
